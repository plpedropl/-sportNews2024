...
<header>
  <nav class="navbar navbar-expand-md navbar-dark fixed-top" style="background:#121212">
    <div class="container-fluid">
      ...
      <a href="/" style="margin: 0px 30px"> <img style="width:180px; height:80px" src="images/main_logo.png" alt="SportNews"></a>
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          ...
          <li class="nav-item">
          <a style="font-family: Montserrat;color:white; font-size: 24px;font-style: normal;font-weight: bold;line-height: normal;margin: 0px 20px" class="nav-link" href="sportCatalogue">Категории</a>
          </li>
          ...
          <li class="nav-item dropdown">
            <a style="font-family: Montserrat;color:white; font-size: 24px;font-style: normal;font-weight: 500;line-height: normal; margin: 0px 20px" class="nav-link dropdown-toggle" href="#" id="dropdown01" data-bs-toggle="dropdown" aria-expanded="false">Игроки</a>
            <ul class="dropdown-menu" aria-labelledby="dropdown01">
            <?php 
                foreach ($allcategories as $categories) {
                  echo '<li><a class="dropdown-item" href="players?category='.$categories['id'].'">'.$categories['title'].'</a></li>';
                }
              ?>
            </ul>
          </li>
        ...
        <form class="d-flex" method="GET" action="search" style="margin: 0px 30px">
          <input class="form-control me-2" type="text" name="player" placeholder="Поиск" style="margin-left: 20px; height: 45px; font-size: 20px;" aria-label="Search">
          <button type="submit" style="border-radius: 10px;background: #2588FC;color:white; height: 45px; font-size: 20px;" class="btn" type="submit">Найти</button>
        </form>
      </div>
    </div>
  </nav>
	...
	<!-- start footer -->
  <footer class="navbar fixed-bottom navbar-expand-sm" style="background:#121212; height: 100px;">
  <div class="container-fluid-footer" style="font-size: 20px;">
