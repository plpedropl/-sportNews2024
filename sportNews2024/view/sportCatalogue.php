...
?>
    ...
    <div class="col-lg-4 col-md-8 mx-auto">
        <h1 style="margin-top:120px; text-align:center" class="mb-4">Виды спорта</h1> <!-- Уменьшенный верхний отступ для заголовка -->
        <br>
        <br>
    </div>

<div class="container mb-4" style="margin-bottom:200px;"> <!-- Уменьшенный отступ перед началом карточек -->
