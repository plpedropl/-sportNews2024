    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="POST" action="profileAddNews">
          ...
          <div class="form-group">
            <label for="date_publish" class="control-label">Публикация</label>
            <input type="text" class="form-control" id="date_publish" name="date_publish" required>
          </div>
          <div class="form-group">
      ...
      <div class="modal-body">
        ...
        <form method="POST" action="profileAddMatch">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="score" name="score" value="-:-" required>
          </div>
          <!-- <div class="form-group">
