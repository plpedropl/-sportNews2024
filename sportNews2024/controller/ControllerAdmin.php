...
class ControllerAdmin {
	...
	public static function playersEditResult($code){
		...
		header("Location: players?category=".$code);
	}
	...
	public static function matchEditResult($code){
		$result = ModelAdmin::editMatch($code);
		header("Location: tourdetail?id=".$code);
	}

	public static function matchDeleteResult($code){
		$result = ModelAdmin::deleteMatch($code);
		header("Location: tourdetail?id=".$code);
	}
}
?>